...
CD_control_obj = CD_control(N_blocks = N_blocks, unitary_optimization=True, no_CD_end=False,
...
CD_control_obj.unitary_initial_states = CD_control_obj.target_unitary.eigenstates()[1][:n]
CD_control_obj.unitary_final_states = CD_control_obj.unitary_initial_states*unitary_eigvals
CD_control_obj.unitary_learning_rate = 1
