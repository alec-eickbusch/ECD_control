...
def plot_wigner(state, alpha= 0.0, tensor_state=True, contour=False, fig=None, ax=None,max_alpha=6, plot_max_alpha=None, cbar=True,
                npts = 81):
    ...
    if contour:
        ...
        im = ax.contourf(xvec2-dx/2.0, yvec2-dx/2.0, W, cmap='seismic',
                        vmin=-1, vmax=+1, levels = levels)
    else:
        im = ax.pcolormesh(yvec2-dx/2.0, xvec2-dx/2.0, W, cmap='seismic',
                    vmin=-1, vmax=+1)
