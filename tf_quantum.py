...
class BatchOperatorMixinBCH:
    ...
    def translate(self, amplitude):
        ...
        amplitude = tf.cast(tf.reshape(amplitude, [amplitude.shape[0], 1]), dtype=c64)
    ...
    def rotate(self, angle):
        ...
        return tf.cast(self._U_n @ expm_n @ tf.linalg.adjoint(self._U_n), dtype=c64,)
    ...
    def rotate_qb(self, phi, axis):
        ...
        return tf.cast(U @ exp_eig @ tf.linalg.adjoint(U), dtype=c64,)
