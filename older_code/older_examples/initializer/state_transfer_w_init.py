...
init_order = None
CD_control_obj_init = CD_control_init(initial_state=initial_state, target_state=target_state, max_N=max_N,\
...
#%% 
CD_control_obj_init.binary_initialize()

#%% 
CD_control_obj = CD_control(CD_control_init_obj=CD_control_obj_init, N_blocks=max_N,
                    name=name, term_fid=term_fid,
                    max_alpha = max_alpha, max_beta=max_beta,
                    saving_directory=saving_directory,
                    basinhopping_kwargs={'T':0.1},
